...
import main from './';
```
Component React class decomposition
```javascript
//use
...
```
Stateless component make as function
```javascript
//use 
...
```
Paste export default to the last line
```javascript
//use 
...
```
Required naming all component containers
```javascript
//use
//./components/Foo
...
let FooContainer = reduxForm({})(Foo)

FooContainer = connect(mapStateToProps,mapDispathToProps)(FooContainer);
...
export default reduxForm({})(Foo);

//./containers/FooContainer

let FooContainer = reduxForm({})(Foo)

export default connect(mapStateToProps,mapDispathToProps)(FooContainer);
```
